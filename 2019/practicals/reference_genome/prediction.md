...
You have uniref50 database available in your `~/2019-09-BIO721_input` directory. This can be used as a reference database for your BLAST. BLAST can produce outputs in different formats, including HTML format, which may be more amenable for inspection.
